if(document.getElementById('homePageSketch3')){
     sketchId3 = 'homePageSketch3'
}else{
     sketchId3 = 'scene'
}
...
const sketch3 = (p) => {
  ...
  p.setup = function() {
    var b = document.getElementById(sketchId3);
    ...
    if(document.getElementById('homePageSketch3')){ _height = 250; }
    var renderer = p.createCanvas(_width, _height);
    renderer.parent(sketchId3);
