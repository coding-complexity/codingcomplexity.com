if(document.getElementById('homePageSketch1')){
     sketchId1 = 'homePageSketch1'
}else{
     sketchId1 = 'scene'
}
...
const sketch1 = (p) => {
  ...
  p.setup = function() {
    var b = document.getElementById(sketchId1);
    ...
    if(document.getElementById('homePageSketch1')){ _height = 250; }
    var renderer = p.createCanvas(_width, _height);
    renderer.parent(sketchId1);
