if(document.getElementById('homePageSketch2')){
     sketchId2 = 'homePageSketch2'
}else{
     sketchId2 = 'scene'
}
...
const sketch2 = (p) => {
  ...
  p.setup = function() {
    var b = document.getElementById(sketchId2);
    ...
    if(document.getElementById('homePageSketch2')){ _height = 250; }
    var renderer = p.createCanvas(_width, _height);
    renderer.parent(sketchId2);
